...
const BodyMapView = ({ bodyMapView, setBodyMapView, onBodyPartClick, entries }) => {
  const frontImageUrl = 'https://efgtznvrnzqcxmfmjuue.supabase.co/storage/v1/object/public/images/1531.png';
  const rearImageUrl = 'https://efgtznvrnzqcxmfmjuue.supabase.co/storage/v1/object/public/images/1530.png';
