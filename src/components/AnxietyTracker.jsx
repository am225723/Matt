...
const AnxietyTracker = ({ onBack }) => {
  ...
  // Handle triple-click to open calibration
  ...
  const handleCalibrationSave = (calibrationData) => {
    // Calibration is already saved in the component
  ...
  return (
    <div className="container mx-auto p-4 sm:p-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h2 className="text-3xl font-bold flex items-center cursor-pointer select-none" onClick={handleTitleClick} title="Triple-click to open calibration">
